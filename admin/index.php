...
if(isset($_POST['delete_admin'])){
	...
	$sqltwo=$dbcon->query("DELETE FROM user_chore_relations WHERE userid='$id'");
}
?>
	...
	<div id="content">
		...
		?>
			<form method="post">
				...
				<?php if(isset($_POST['edit_sub_admin']) && $_POST['username']!=="" && $_POST['passcode']!==""){ echo "<br /><em>Updated! You will need to login again if you changed your username. If update didn't work, then you used a username that exists already.</em>"; } ?>
